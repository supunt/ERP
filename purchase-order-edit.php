...
<div class="gsectionbtn"><a href="classes/purchaselistdelete.php?action=delete&id=<?php echo $row['podid']; ?>&pid=<?php echo $pid; ?>" onClick="return confirm('Are you sure?')" class="delete" >Delete </a></div>
<?php  }} ?>
</div>
...
<div class="gsectionbtn"> <input type="submit" value="Add New" > </div>
</div>
