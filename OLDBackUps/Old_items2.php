...
<option <?php echo $selected; ?> value="" ><?php echo $_GET['name'] ?></opiton>
			...
			<div class="row">
				<div class="title">&nbsp;</div>
				<div class="input"> 
               <?php if($_GET['action'] == 'delete') {?>  <a href="classes/itemMaster.php?action=delete&id=<?php echo $_GET['id']; ?>" onClick="return confirm('Are you sure?')" class="delete" >Delete </a> <?php } ?>
