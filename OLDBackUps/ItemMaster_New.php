...
<?php
    ...
    $selected = '';
    $id = '';
    $alldata = "SELECT * FROM ItemMaster order by Id desc";
    ...
    if ($_GET['action'] == 'update') {
        $method = 'update';
        $id = $_GET['id'];
        $rowData = "SELECT * FROM ItemMaster where Id=" . $id;
            ...
            <form id="frm_vendor" action="classes/vendorMaster.php" method="POST">
                    ...
                    <div class="input">
                        ...
                        if ($_GET['mode'] == 'add') {
                            ...
                            <input class="txt_name" name="vname"
                                   value="<?php echo($_GET['action'] == 'update' ? $updaterow['vname'] : ''); ?>"/>
                            <?php
                        }
                ...
                <div class="row">
                    ...
                    <div class="input"><textarea
                            name="description" <?php echo($_GET['action'] == 'delete' ? "readonly" : ''); ?> ><?php echo($_GET['action'] == 'update' ? $updaterow['description'] : ''); ?><?php echo($_GET['action'] == 'delete' ? $updaterow['description'] : ''); ?></textarea>
                    </div>
                    ...
                    <div class="input"><textarea
                            name="extraf1" <?php echo($_GET['action'] == 'delete' ? "readonly" : ''); ?> ><?php echo($_GET['action'] == 'update' ? $updaterow['extrafield1'] : ''); ?><?php echo($_GET['action'] == 'delete' ? $updaterow['extrafield1'] : ''); ?></textarea>
                    </div>
                    <div class="title">Extra field 2 :</div>
                    <div class="input"><textarea
                            name="extraf2" <?php echo($_GET['action'] == 'delete' ? "readonly" : ''); ?> ><?php echo($_GET['action'] == 'update' ? $updaterow['extrafield2'] : ''); ?><?php echo($_GET['action'] == 'delete' ? $updaterow['extrafield2'] : ''); ?></textarea>
                    </div>
                    <div class="title">Extra field 2 :</div>
                    <div class="input"><textarea
                            name="extraf3" <?php echo($_GET['action'] == 'delete' ? "readonly" : ''); ?> ><?php echo($_GET['action'] == 'update' ? $updaterow['extrafield3'] : ''); ?><?php echo($_GET['action'] == 'delete' ? $updaterow['extrafield3'] : ''); ?></textarea>
                    </div>
